<template>
  <main class="content">
    <BreadCrumbs :slug="{ name: dealId, title: `Заказ №${dealId}` }" />
    <section class="dial">
      <div class="container">
        <div class="row">
          <div class="col-9">
            ...
            <div class="dial-doc-info mt-4">
              ...
              <div class="dial-companies-info">
                <CompanyCard v-if="deal.customer" :company="deal.customer">
                  <h4>Данные компании-покупателя</h4>
                </CompanyCard>
                <CompanyCard v-if="deal.seller" :company="deal.seller">
